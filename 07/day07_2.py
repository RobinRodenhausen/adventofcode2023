...
class Hand:
    ...
    def is_five(self) -> bool:
        ...
        for key in d.keys():
            if d[key] == 5:
                return True
            if key != 1 and d[key] + self.jokers == 5:
                return True
        return False
    ...
    def is_four(self) -> bool:
        d = collections.Counter(self.cards)
        for key in d.keys():
            if key != 1 and d[key] + self.jokers == 4:
                return True
        return False
        ...
        if len(d.keys()) == 2:
            for key in d.keys():
                if d[key] == 2 or d[key] == 3:
                    return True
        if 1 in d.keys() and len(d.keys()) == 3:
            for key in d.keys():
                if key != 1 and d[key] + self.jokers == 2 or d[key] + self.jokers == 3:
                    return True
